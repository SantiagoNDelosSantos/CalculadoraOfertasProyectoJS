...
function resolverCalculoSalida() {
    ...
    if (calcularDescuento.toLowerCase() == "si") {
        ...
        console.log("El descuento es de $" + valorDescuento + " y el precio final de tu producto en oferta es de $" + precioFinal + ".")

        alert("El descuento es de $" + valorDescuento + " y el precio final de tu producto en oferta es de $" + precioFinal + ".")

    } else(calcularDescuento.toLowerCase() == "no")

    {
        let respuesta = prompt("¿Desea realizar el cálculo con otros valores? Presione Si en caso afirmativo y No si desea salir de la calculadora.")
